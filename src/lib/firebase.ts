...
export async function seedInitialDataIfEmpty() {
  try {
    ...
    try {
      ...
      console.warn('Seeding: Could not read crowd_status (might be unauthenticated or offline):', error);
      return; // Fail gracefully
    }
    
    if (crowdSnap && crowdSnap.empty) {
      ...
      try {
        ...
        console.warn('Seeding: Missing permissions to seed crowd_status (requires staff role):', error);
      }
    }
    ...
    try {
      ...
      console.warn('Seeding: Could not read transportation (might be unauthenticated or offline):', error);
      return; // Fail gracefully
    }
    ...
    if (transSnap && transSnap.empty) {
      ...
      try {
        ...
        console.warn('Seeding: Missing permissions to seed transportation (requires staff role):', error);
      }
    }
  } catch (error) {
